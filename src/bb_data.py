...
test1 = get_labeled_raw_data(r"../data/15_9-F-1 A_BIOSTRAT_RAW_1.DEX", r"../data/15_9-F-1 A_BIOSTRAT_COMPUTED_1.DEX")
test2 = get_labeled_raw_data(r"../data/15_9-F-1 B_BIOSTRAT_RAW_1.DEX", r"../data/15_9-F-1 B_BIOSTRAT_COMPUTED_1.DEX")
test3 = get_labeled_raw_data(r"../data/15_9-F-1_BIOSTRAT_RAW_1.DEX", r"../data/15_9-F-1_BIOSTRAT_COMPUTED_1.DEX")
test4 = get_labeled_raw_data(r"../data/15_9-F-11 A_BIOSTRAT_RAW_1.DEX", r"../data/15_9-F-11 A_BIOSTRAT_COMPUTED_1.DEX")
test5 = get_labeled_raw_data(r"../data/15_9-F-11 B_BIOSTRAT_RAW_1.DEX", r"../data/15_9-F-11 B_BIOSTRAT_COMPUTED_1.DEX")
label_raw_data = pd.concat([test1, test2,test3,test4,test5], sort=True)
label_raw_data=label_raw_data.replace(np.nan, 0)

raw_data_fns = [r"../data/15_9-F-1 A_BIOSTRAT_RAW_1.DEX", r"../data/15_9-F-1 B_BIOSTRAT_RAW_1.DEX",
              r"../data/15_9-F-1_BIOSTRAT_RAW_1.DEX",r"../data/15_9-F-11 A_BIOSTRAT_RAW_1.DEX",
              r"../data/15_9-F-11 B_BIOSTRAT_RAW_1.DEX"]
